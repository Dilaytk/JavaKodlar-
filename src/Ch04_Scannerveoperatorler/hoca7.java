package Ch04_Scannerveoperatorler;

public class hoca7 { public static void main(String[] args) {
  ...
  Unlem isareti (!) olumsuzluk anlaminda kullanilir.
    ...
    // sarı olan yas1==yas2nin üzerine geldiğinde alttaki yazı çıkıyo. sarı şey hep böyle kesin hep true çıkar hep false
