...
public class hoca6proje {
    //data base mantiginca bankada tutulan sifre creat edin
    static String password = "12345" ;//kullanicinin bankaa kayitli olan sifresi gibi dusunun. yani bir şifre kayıtlı olmalı
    // static yazınca başına her yerden ulaşılabiliyor
     ...
     */
        ...
        if (sifre.equals(password)){   // buralara ; koyma lütfen
            // ve if in sonuna { else in basına } koy
            ...
            switch (secim){
                ...
                case 2 :
                    ...
                    bakiye += yatirilacakMiktar ;  // yatırılacak miktarı bakiyeye atadım ekledim
